...
| 2 | goal-domain-process-mapper | Required process and failure modes | complete | `.goal-specs/intermediate/<YYYY-MM-DD-slug>/02-domain-process.yaml` |
| 3 | goal-freedom-policy-designer | Freedom policy | complete | `.goal-specs/intermediate/<YYYY-MM-DD-slug>/03-freedom-policy.yaml` |
| 4 | goal-decomposer | Aggregate and story goals | complete | `.goal-specs/intermediate/<YYYY-MM-DD-slug>/04-decomposition.yaml` |
| 5 | goal-verifier-designer | Verifier plan | complete | `.goal-specs/intermediate/<YYYY-MM-DD-slug>/05-verifier-plan.yaml` |
| 6 | goal-state-ledger-architect | State and ledger | complete | `.goal-specs/intermediate/<YYYY-MM-DD-slug>/06-state-ledger.yaml` |
| 7 | goal-steering-policy-designer | Steering policy | complete | `.goal-specs/intermediate/<YYYY-MM-DD-slug>/07-steering-policy.yaml` |
| 8 | goal-handoff-writer | Execution handoff | complete | `.goal-specs/intermediate/<YYYY-MM-DD-slug>/08-execution-handoff.yaml` |
| 9 | goal-self-deepinterview | Intent alignment audit | ALIGNED | `.goal-specs/intermediate/<YYYY-MM-DD-slug>/09-self-deepinterview.yaml` |
| 10 | goal-spec-critic | Critic verdict | APPROVE | `.goal-specs/intermediate/<YYYY-MM-DD-slug>/10-critic-verdict.yaml` |
