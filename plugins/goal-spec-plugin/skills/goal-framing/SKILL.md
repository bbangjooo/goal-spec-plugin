...
This agent turns raw user language into the stable goal object that all later
...
The next agent should be able to design constraints from `final_goal` and
`goal_object_model` without reading the raw conversation.
